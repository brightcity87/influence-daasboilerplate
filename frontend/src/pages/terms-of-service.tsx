      ...
      <Container maxW="container.md" py={10}>
        <VStack spacing={6} align="stretch">
          ...
          <Box>
            ...
            <br />
            <Text>
              1.1. Scope. These License Terms and Conditions are entered into by and between Customer and leadsinc.com (“Leadsinc”, “we”, or “us”). The following terms and conditions, together with any other documents expressly incorporated by reference (collectively, the “License Terms”), govern (i) Customer’s access to and use of www.leadsinc.com and the content and functionality offered on or through www.leadsinc.com (collectively, the “Website”), and (ii) Customer’s use of Leadsinc’s proprietary, hosted service database product and/or application programming interface offerings (the “Subscription Services”) and the all associated documentation (if any) (the “Documentation” and, together with the Subscription Services, the “Product”). The effective date of these License Terms as to Customer’s use of the Website, Subscription Services, or the Product is the date that you first accept or agree to these License Terms.
              <br />
              <br />
              ...
              <br />
              <br />
              IMPORTANT: PLEASE REVIEW THE MUTUAL ARBITRATION AGREEMENT SET FORTH BELOW CAREFULLY, AS IT WILL REQUIRE CUSTOMER TO RESOLVE DISPUTES WITH LEADSINC ON AN INDIVIDUAL BASIS (WAIVING CUSTOMER’S RIGHT TO A CLASS ACTION) THROUGH FINAL AND BINDING ARBITRATION. BY ENTERING THIS AGREEMENT, CUSTOMER EXPRESSLY ACKNOWLEDGES THAT CUSTOMER HAS READ AND UNDERSTANDS ALL OF THE TERMS OF THIS MUTUAL ARBITRATION AGREEMENT AND HAS TAKEN THE TIME TO CONSIDER THE CONSEQUENCES OF THIS IMPORTANT DECISION.
            </Text>
          </Box>
          ...
          <Box>
            ...
            <Text>
              ...
              <br />
              <br />
              3.8. Feedback. Customer agrees to make reasonable efforts to provide Leadsinc with oral feedback and/or written feedback related to Customer’s use of the Product, including, but not limited to, a report of any errors which Customer discovers in the Subscription Services or related Documentation. Such reports, and any other materials, information, ideas, concepts, feedback and know-how provided by Customer to Leadsinc concerning the Product and any information reported automatically through the Product to Leadsinc (“Feedback”) will be the property of Leadsinc. Customer agrees to assign, and hereby assign, all right, title and interest worldwide in the Feedback, and the related intellectual property rights, to Leadsinc and agrees to assist Leadsinc, at Leadsinc’s expense, in perfecting and enforcing such rights.
              <br />
              <br />
              3.9. License to Branding Elements. Customer hereby grants to Leadsinc a non-exclusive, royalty-free, irrevocable, and worldwide license to use Customer’s trademarks, service marks, trade dress, trade names, brand names, logos, corporate names, domain names, and other branding elements on or in connection with Leadsinc’s promotional, advertising, and marketing materials in all formats and media, including, without limitation, on lists of Leadsinc’s current or former customers and on advertisements for Leadsinc and/or the Product, Subscription Services, and/or the Website.We collect and store user data, including name, email, and payment information, as necessary to provide
          ...
          <Box>
            ...
            <Text>5.1. Obligations. Customer must comply with all applicable federal, state and local laws, rules, regulations, and ordinances relating to telemarketing, data privacy, consumer protection, and any others laws that may relate to Customer’s use of the Subscription Services, Product, and Data, including, without limitation, the CAN-SPAM Act, the Telephone Consumer Protection Act, the General Data Protection Regulation of the European Union, and the California Consumer Privacy Act. Customer shall not, and shall not permit any third party to, license, sell, rent, lease, transfer, assign, distribute to any third party, or commercially exploit the Data, in whole or in part, or use the Data in connection with credit granting, credit monitoring, account review, collections, insurance underwriting, employment or any other purpose covered by the Fair Credit Reporting Act (“FCRA”), interpretations of the FCRA by the Federal Trade Commission, or by similar federal and state statutes.
              <br />
              <br />
              5.2. Indemnification. Customer agrees that Customer will indemnify, defend and hold Leadsinc harmless against any losses resulting from any third party claim against Leadsinc arising out of or in connection with any violation of any applicable law by Customer.</Text>
          </Box>
          ...
          <Box>
            ...
            <br />
            <Text>
              If Customer violates these License Terms, Leadsinc may terminate and/or suspend Customer’s access to this Website without notice. Leadsinc prefers to advise Customer of Customer’s inappropriate behavior and to recommend any necessary corrective action. However, certain violations of these License Terms, as determined by Leadsinc, may result in immediate termination. If any of these License Terms is found to be inconsistent with applicable law, then such term shall be interpreted to reflect the intentions of the parties, and no other terms will be modified. Leadsinc’s failure to enforce any of these License Terms is not a waiver of such term. These License Terms are the entire agreement between Customer and Leadsinc and supersede all prior or contemporaneous negotiations, discussions or agreements between Customer and Leadsinc about the Website and/or the Product. Customer shall not assign or otherwise transfer any of Customer’s rights, or delegate or otherwise transfer any of Customer’s obligations or performance under these License Terms without our prior written consent.
              <br />
              <br />
