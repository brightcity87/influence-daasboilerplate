...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hasAccess: Attribute.Boolean & Attribute.DefaultTo<false>;
    priceId: Attribute.String;
    customerId: Attribute.String;
    userid: Attribute.String;
    uuid: Attribute.String;
    githubUsername: Attribute.String;
    subscriptionTier: Attribute.Relation<"plugin::users-permissions.user", "manyToOne", "api::product.product">;
    subscriptionStatus: Attribute.Enumeration<["active", "inactive", "canceled"]> & Attribute.DefaultTo<"inactive">;
    subscriptionStartDate: Attribute.DateTime;
    subscriptionEndDate: Attribute.DateTime;
    allowance: Attribute.JSON &
    Attribute.DefaultTo<{
      searchCount: 0;
      exportCount: 0;
      exportFormat: "csv";
    ...
    downloadMetadata: Attribute.JSON & Attribute.DefaultTo<{}>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    template: Attribute.Enumeration<["main", "app"]> & Attribute.DefaultTo<"main">;
    seed_database: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiDatabaseDatabase extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::database.database", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::database.database", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiDocumentationDocumentation extends Schema.CollectionType {
  ...
  info: {
    ...
    description: "Platform documentation pages";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
    Attribute.Required;
    related_pages: Attribute.Relation<
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::documentation.documentation", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::documentation.documentation", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiEmailTemplateEmailTemplate extends Schema.CollectionType {
  ...
  info: {
    ...
    description: "Email templates for various system notifications";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    description: Attribute.Text;
    htmlBody: Attribute.Blocks & Attribute.Required;
    textBody: Attribute.Text;
    variables: Attribute.JSON & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::email-template.email-template", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::email-template.email-template", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiFilteroptionFilteroption extends Schema.SingleType {
  collectionName: "filteroptions";
  info: {
    singularName: "filteroption";
    pluralName: "filteroptions";
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::filteroption.filteroption", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::filteroption.filteroption", "oneToOne", "admin::user"> & Attribute.Private;
  };
}

export interface ApiPopularSearchPopularSearch extends Schema.CollectionType {
  collectionName: "popular_searches";
  info: {
    singularName: "popular-search";
    pluralName: "popular-searches";
    displayName: "Popular Searches";
    description: "Manage popular searches shown on the free page";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    searchTerm: Attribute.String & Attribute.Required & Attribute.Unique;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::popular-search.popular-search", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::popular-search.popular-search", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    rank: Attribute.Integer;
    priceId: Attribute.String;
    oldPriceId: Attribute.String;
    mode: Attribute.String & Attribute.DefaultTo<"payment">;
    subscriptionSettings: Attribute.Component<"shared.settings">;
    users: Attribute.Relation<"api::product.product", "manyToMany", "plugin::users-permissions.user">;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiStripeErrorStripeError extends Schema.CollectionType {
  collectionName: "stripe_errors";
  info: {
    singularName: "stripe-error";
    pluralName: "stripe-errors";
    displayName: "Stripe Error";
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    eventId: Attribute.String & Attribute.Required;
    eventType: Attribute.String & Attribute.Required;
    error: Attribute.Text & Attribute.Required;
    timestamp: Attribute.BigInteger & Attribute.Required;
    retryCount: Attribute.Integer & Attribute.DefaultTo<0>;
    lastError: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::stripe-error.stripe-error", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::stripe-error.stripe-error", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiStripeEventStripeEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    processingErrors: Attribute.JSON;
    retryCount: Attribute.Integer & Attribute.DefaultTo<0>;
    lastProcessedAt: Attribute.DateTime;
    lockExpiresAt: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::stripe-event.stripe-event", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::stripe-event.stripe-event", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiWebhookWebhook extends Schema.SingleType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::webhook.webhook", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::webhook.webhook", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
declare module "@strapi/types" {
  export module Shared {
    export interface ContentTypes {
      ...
      "api::filteroption.filteroption": ApiFilteroptionFilteroption;
      "api::popular-search.popular-search": ApiPopularSearchPopularSearch;
      "api::product.product": ApiProductProduct;
      "api::stripe-error.stripe-error": ApiStripeErrorStripeError;
